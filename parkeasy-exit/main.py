    ...
    if detected == 1:
        ...
        with open('listcars.csv', 'r+') as f:
            ...
            if read not in numlist:
                ...
                if len(read) == 10:
                    f.writelines(f'{read},{now.strftime("%Y-%m-%d %H:%M")}')
                    f.writelines('\n')
...
with open('listcars.csv') as csv_file:
   ...
   for row in file:
       value1 = (row[0], row[1])
       all_value.append(value1)
       print("licese plate is:")
       print(all_value)


with open('listcars.csv', 'r') as csv_file:
   csvfile = csv.reader(csv_file, delimiter=',')
   for row in csvfile:
       value = row[0]
       print(value)
       s = smtplib.SMTP_SSL('smtp.gmail.com', 465)
       s.login("parkeasy3@gmail.com", "parkeasykjp@3")
       msg = "Hellooo"
       s.sendmail("parkeasy3@gmail.com", "parkeasy3@gmail.com", msg)
       s.quit()
       print("Finished")
